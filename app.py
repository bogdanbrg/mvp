...
with st.sidebar:
    st.header("About")
    st.write("""
    This dashboard shows key economic indicators and demographics for Romania:
    
    **Real Wages (1991–2023):**
    - Adjusted for inflation to constant 2023 prices
    - Shows the economic recovery after 1990s transition
    
    **GDP Evolution (1990–2025):**
    - Based on current USD
    - Reflects the country's economic development
    
    **Population Pyramid (2023):**
    - Shows age and gender distribution
    - Reveals demographic trends and patterns
    
    **Life Expectancy (1990–2023):**
    - Shows evolution by gender and overall
    - Toggle between gender view and total view
    """)
    
    st.header("Key Insights")
    st.write("""
    - Real wages reached 1991 levels again in 2005
    - Romania joined the EU in 2007
    - Population pyramid shows aging demographic trends
    - Life expectancy has steadily improved over time
    - Women consistently have higher life expectancy than men
    - Indicators show Romania's transformation post-communism
    """)

    st.header("Technical Notes")
    st.write("""
    - Wage data: INS official statistics
    - GDP data: Local CSV file
    - Population data: INS demographic statistics
    - Life expectancy data: INS demographic statistics
    - Real wages adjusted using CPI
    - GDP shown in current US dollars
    """)